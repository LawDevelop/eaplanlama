            ...
            <div className="elite-card w-full h-full overflow-hidden flex flex-col max-h-[calc(100vh-2rem)] sm:max-h-[85vh]">
              ...
              <div className="p-4 sm:p-6 border-b border-gray-100 flex-shrink-0">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h2 className="text-xl sm:text-2xl font-bold">Görev İstatistikleri</h2>
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="hidden sm:flex px-4 py-2 rounded-xl bg-[hsl(var(--secondary))] hover:bg-[hsl(var(--muted))] items-center gap-2 transition-colors text-sm"
                    >
              ...
              <div className="p-4 sm:p-6 overflow-y-auto custom-scrollbar flex-1">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-6">
                  <div className="elite-card p-3 sm:p-4">
                    <div className="text-2xl sm:text-3xl font-bold text-[hsl(var(--primary))]">
                      {stats.totalTasks}
                    </div>
                    <div className="text-xs sm:text-sm text-[hsl(var(--muted-foreground))]">Toplam Görev</div>
                  </div>
                  ...
                  <div className="elite-card p-3 sm:p-4">
                    <div className="text-2xl sm:text-3xl font-bold text-[hsl(var(--warning))]">
                      {stats.inProgressTasks}
                    </div>
                    <div className="text-xs sm:text-sm text-[hsl(var(--muted-foreground))]">Devam Eden</div>
                  </div>

                  <div className="elite-card p-3 sm:p-4">
                    <div className="text-2xl sm:text-3xl font-bold text-[hsl(var(--danger))]">
                      {stats.overdueTasks}
                    </div>
                    <div className="text-xs sm:text-sm text-[hsl(var(--muted-foreground))]">Gecikmiş</div>
                  </div>
                </div>
                      ...
                      <div className="relative w-24 h-24 sm:w-32 sm:h-32">
                        <svg className="w-full h-full transform -rotate-90">
                          ...
                          <motion.circle
                            ...
                            animate={{ strokeDashoffset: 2 * Math.PI * 45 * (1 - stats.productivityScore / 100) }}
                            transition={{ duration: 1, ease: 'easeOut' }}
                          />
                        </svg>
                        <div className="absolute inset-0 flex items-center justify-center">
                          <span className="text-2xl sm:text-3xl font-bold">{stats.productivityScore}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {/* Weekly Activity */}
                <div className="elite-card p-4 sm:p-5 mb-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    {weeklyData.map((day, index) => {
                      ...
                      return (
                        <div key={day.day} className="flex-1 flex flex-col items-center gap-1 sm:gap-2">
                          <div className="w-full flex gap-0.5 sm:gap-1 items-end h-24 sm:h-32">
                            <motion.div
                              initial={{ height: 0 }}
                              animate={{ height: `${completedHeight}%` }}
                              transition={{ duration: 0.5, delay: index * 0.1 }}
                              className="flex-1 gradient-success rounded-t-sm sm:rounded-t-lg"
                            ...
                            <motion.div
                              ...
                              transition={{ duration: 0.5, delay: index * 0.1 }}
                              className="flex-1 gradient-primary rounded-t-sm sm:rounded-t-lg"
                              title={`${day.created} oluşturuldu`}
                            />
                          </div>
                          <span className="text-[10px] sm:text-xs text-[hsl(var(--muted-foreground))]">{day.day}</span>
                        </div>
                      )
                    })}
                  </div>
                  <div className="flex items-center justify-center gap-4 sm:gap-6 mt-3 sm:mt-4 text-xs sm:text-sm">
                    <div className="flex items-center gap-1 sm:gap-2">
                      <div className="w-2 sm:w-3 h-2 sm:h-3 rounded gradient-success" />
                      <span>Tamamlanan</span>
                    </div>
                    <div className="flex items-center gap-1 sm:gap-2">
                      <div className="w-2 sm:w-3 h-2 sm:h-3 rounded gradient-primary" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 mb-6">
                  <div className="elite-card p-3 sm:p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs sm:text-sm text-[hsl(var(--muted-foreground))]">Toplam Süre</span>
                    </div>
                  ...
                  <div className="elite-card p-3 sm:p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs sm:text-sm text-[hsl(var(--muted-foreground))]">Pomodoro</span>
                    </div>
                    <div className="text-xl sm:text-2xl font-bold text-[hsl(var(--success))]">
                  ...
                  <div className="elite-card p-3 sm:p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs sm:text-sm text-[hsl(var(--muted-foreground))]">Ort. Süre</span>
                    </div>
                    <div className="text-xl sm:text-2xl font-bold text-[hsl(var(--warning))]">
                ...
                {stats.overdueTasks > 0 && (
                  <div className="elite-card p-4 sm:p-5 bg-[hsl(var(--warning))]/10 border-[hsl(var(--warning))]/20">
                    <div className="flex items-start gap-3">
                      <AlertCircle className="w-5 h-5 text-[hsl(var(--warning))] flex-shrink-0 mt-0.5" />
                      <div>
                        <h3 className="font-semibold mb-1 text-sm sm:text-base">Dikkat!</h3>
